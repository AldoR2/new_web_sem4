              ...
              <div class="flex flex-col lg:flex-row gap-6">
                  <div class="flex flex-col items-center lg:items-start">
                      ...
                      <button @click="openModal = true"
                              class="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 flex items-center gap-2">
                          ...
                          <div class="space-y-4">
                              ...
                              <div class="space-y-3">
                                  <div class="flex items-start gap-3">
                                      ...
                                      <div class="flex-1">
                                          <span class="text-sm font-medium text-gray-500 dark:text-gray-400 block">Nama Lengkap</span>
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->nama}}</span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="flex items-start gap-3">
                                      <div class="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                                      <div class="flex-1">
                                          <span class="text-sm font-medium text-gray-500 dark:text-gray-400 block">NIM</span>
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->nim}}</span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="flex items-start gap-3">
                                      ...
                                      <div class="flex-1">
                                          ...
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan'}}</span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="flex items-start gap-3">
                                      ...
                                      <div class="flex-1">
                                          ...
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->tempat_lahir}}, {{$biodata->tgl_lahir}}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="space-y-3">
                                  <div class="flex items-start gap-3">
                                      ...
                                      <div class="flex-1">
                                          ...
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->prodi->nama_prodi}}</span>
                                      </div>
                                  </div>
                                  ...
                                  <div class="flex items-start gap-3">
                                      ...
                                      <div class="flex-1">
                                          ...
                                          <span class="text-gray-800 dark:text-white font-medium">{{$biodata->semester}}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div class="flex items-start gap-3">
                                  ...
                                  <div class="flex-1">
                                      ...
                                      <span class="text-gray-800 dark:text-white font-medium break-all">{{$biodata->email}}</span>
                                  </div>
                              </div>
                              ...
                              <div class="flex items-start gap-3">
                                  ...
                                  <div class="flex-1">
                                      ...
                                      <span class="text-gray-800 dark:text-white font-medium">{{$biodata->no_telp}}</span>
                                  </div>
                              </div>
                          </div>
                  ...
                  <form method="POST" action="{{route('mahasiswa.profil.update')}}" enctype="multipart/form-data" class="p-6">
                      ...
                      <div class="flex gap-3">
                          <button type="button"
                                  ...
                                  class="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200">
                              Batal
                          </button>
                          <button type="submit"
                                  class="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-green-600 hover:bg-green-700 text-white transition-colors duration-200 transform hover:scale-105">
                              Simpan Foto
                          </button>
                      </div>
                  </form>
